    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                ...
                <div class="lead"><p>View User Trials</p></div>
 </div>
        </div>
    </div>
</section> 
...
<table id="users" class="display  table table-hover table-responsive"  >
...
<table id="usertrys"class= "display table table-hover table-responsive">
